...
import { saveBlog } from "../utils/index.js";
    ...
    <div className="max-w-3xl px-6 py-16 mx-auto space-y-12">
      <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
        <div className="space-y-6">
          ...
          className="bg-primary p-3 ml-5 rounded-full hover:bg-opacity-30 bg-opacity-30 cursor-pointer hover:scale-105 overflow-hidden">
